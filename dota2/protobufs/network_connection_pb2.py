...
_ENETWORKDISCONNECTIONREASON = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      serialized_options=_b('\242\324\030\037#GameUI_Disconnect_LoopShutdown'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOOPDEACTIVATE', index=55, number=55,
      serialized_options=_b('\242\324\030!#GameUI_Disconnect_LoopDeactivate'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_HOST_ENDGAME', index=56, number=56,
      serialized_options=_b('\242\324\030\037#GameUI_Disconnect_Host_EndGame'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOOP_LEVELLOAD_ACTIVATE', index=57, number=57,
      serialized_options=_b('\242\324\030(#GameUI_Disconnect_LoopLevelLoadActivate'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CREATE_SERVER_FAILED', index=58, number=58,
      serialized_options=_b('\242\324\030%#GameUI_Disconnect_CreateServerFailed'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_EXITING', index=59, number=59,
      serialized_options=_b('\242\324\030 #GameUI_Disconnect_ExitingEngine'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REQUEST_HOSTSTATE_IDLE', index=60, number=60,
      serialized_options=_b('\242\324\030!#GameUI_Disconnect_Request_HSIdle'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REQUEST_HOSTSTATE_HLTVRELAY', index=61, number=61,
      serialized_options=_b('\242\324\030$#GameUI_Disconnect_Request_HLTVRelay'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CLIENT_CONSISTENCY_FAIL', index=62, number=62,
      serialized_options=_b('\242\324\030\035#GameUI_ClientConsistencyFail'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CLIENT_UNABLE_TO_CRC_MAP', index=63, number=63,
      serialized_options=_b('\242\324\030\034#GameUI_ClientUnableToCRCMap'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CLIENT_NO_MAP', index=64, number=64,
      serialized_options=_b('\242\324\030\023#GameUI_ClientNoMap'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CLIENT_DIFFERENT_MAP', index=65, number=65,
      serialized_options=_b('\242\324\030\032#GameUI_ClientDifferentMap'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_SERVER_REQUIRES_STEAM', index=66, number=66,
      serialized_options=_b('\242\324\030\033#GameUI_ServerRequireSteams'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_STEAM_DENY_MISC', index=67, number=67,
      serialized_options=_b('\242\324\030!#GameUI_Disconnect_SteamDeny_Misc'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_STEAM_DENY_BAD_ANTI_CHEAT', index=68, number=68,
      serialized_options=_b('\242\324\030)#GameUI_Disconnect_SteamDeny_BadAntiCheat'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_SERVER_SHUTDOWN', index=69, number=69,
      serialized_options=_b('\242\324\030!#GameUI_Disconnect_ServerShutdown'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_SPLITPACKET_SEND_OVERFLOW', index=70, number=70,
      serialized_options=_b('\242\324\030,#GameUI_Disconnect_Splitpacket_Send_Overflow'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REPLAY_INCOMPATIBLE', index=71, number=71,
      serialized_options=_b('\242\324\030%#GameUI_Disconnect_ReplayIncompatible'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_CONNECT_REQUEST_TIMEDOUT', index=72, number=72,
      serialized_options=_b('\242\324\030%#GameUI_Disconnect_ConnectionTimedout'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_SERVER_INCOMPATIBLE', index=73, number=73,
      serialized_options=_b('\242\324\030%#GameUI_Disconnect_ServerIncompatible'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOCALPROBLEM_MANYRELAYS', index=74, number=74,
      serialized_options=_b('\242\324\030*#GameUI_Disconnect_LocalProblem_ManyRelays'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOCALPROBLEM_HOSTEDSERVERPRIMARYRELAY', index=75, number=75,
      serialized_options=_b('\242\324\0308#GameUI_Disconnect_LocalProblem_HostedServerPrimaryRelay'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOCALPROBLEM_NETWORKCONFIG', index=76, number=76,
      serialized_options=_b('\242\324\030-#GameUI_Disconnect_LocalProblem_NetworkConfig'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_LOCALPROBLEM_OTHER', index=77, number=77,
      serialized_options=_b('\242\324\030%#GameUI_Disconnect_LocalProblem_Other'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REMOTE_TIMEOUT', index=78, number=79,
      serialized_options=_b('\242\324\030(#GameUI_Disconnect_RemoteProblem_Timeout'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REMOTE_TIMEOUT_CONNECTING', index=79, number=80,
      serialized_options=_b('\242\324\0302#GameUI_Disconnect_RemoteProblem_TimeoutConnecting'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REMOTE_OTHER', index=80, number=81,
      serialized_options=_b('\242\324\030&#GameUI_Disconnect_RemoteProblem_Other'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REMOTE_BADCRYPT', index=81, number=82,
      serialized_options=_b('\242\324\030)#GameUI_Disconnect_RemoteProblem_BadCrypt'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REMOTE_CERTNOTTRUSTED', index=82, number=83,
      serialized_options=_b('\242\324\030(#GameUI_Disconnect_RemoteProblem_BadCert'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_UNUSUAL', index=83, number=84,
      serialized_options=_b('\242\324\030\032#GameUI_Disconnect_Unusual'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_INTERNAL_ERROR', index=84, number=85,
      serialized_options=_b('\242\324\030 #GameUI_Disconnect_InternalError'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_BADCHALLENGE', index=85, number=128,
      serialized_options=_b('\242\324\030 #GameUI_ServerRejectBadChallenge'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_NOLOBBY', index=86, number=129,
      serialized_options=_b('\242\324\030\025#GameUI_ServerNoLobby'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_BACKGROUND_MAP', index=87, number=130,
      serialized_options=_b('\242\324\030\034#Valve_Reject_Background_Map'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_SINGLE_PLAYER', index=88, number=131,
      serialized_options=_b('\242\324\030\033#Valve_Reject_Single_Player'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_HIDDEN_GAME', index=89, number=132,
      serialized_options=_b('\242\324\030\031#Valve_Reject_Hidden_Game'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_LANRESTRICT', index=90, number=133,
      serialized_options=_b('\242\324\030\037#GameUI_ServerRejectLANRestrict'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_BADPASSWORD', index=91, number=134,
      serialized_options=_b('\242\324\030\037#GameUI_ServerRejectBadPassword'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_SERVERFULL', index=92, number=135,
      serialized_options=_b('\242\324\030\036#GameUI_ServerRejectServerFull'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_INVALIDRESERVATION', index=93, number=136,
      serialized_options=_b('\242\324\030&#GameUI_ServerRejectInvalidReservation'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_FAILEDCHANNEL', index=94, number=137,
      serialized_options=_b('\242\324\030!#GameUI_ServerRejectFailedChannel'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_CONNECT_FROM_LOBBY', index=95, number=138,
      serialized_options=_b('\242\324\030 #Valve_Reject_Connect_From_Lobby'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_RESERVED_FOR_LOBBY', index=96, number=139,
      serialized_options=_b('\242\324\030 #Valve_Reject_Reserved_For_Lobby'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_INVALIDKEYLENGTH', index=97, number=140,
      serialized_options=_b('\242\324\030%#GameUI_ServerReject_InvalidKeyLength'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_OLDPROTOCOL', index=98, number=141,
      serialized_options=_b('\242\324\030\037#GameUI_ServerRejectOldProtocol'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_NEWPROTOCOL', index=99, number=142,
      serialized_options=_b('\242\324\030\037#GameUI_ServerRejectNewProtocol'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_INVALIDCONNECTION', index=100, number=143,
      serialized_options=_b('\242\324\030%#GameUI_ServerRejectInvalidConnection'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_INVALIDCERTLEN', index=101, number=144,
      serialized_options=_b('\242\324\030\"#GameUI_ServerRejectInvalidCertLen'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_INVALIDSTEAMCERTLEN', index=102, number=145,
      serialized_options=_b('\242\324\030\'#GameUI_ServerRejectInvalidSteamCertLen'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_STEAM', index=103, number=146,
      serialized_options=_b('\242\324\030\031#GameUI_ServerRejectSteam'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_SERVERAUTHDISABLED', index=104, number=147,
      serialized_options=_b('\242\324\030\032#GameUI_ServerAuthDisabled'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_SERVERCDKEYAUTHINVALID', index=105, number=148,
      serialized_options=_b('\242\324\030\036#GameUI_ServerCDKeyAuthInvalid'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NETWORK_DISCONNECT_REJECT_BANNED', index=106, number=149,
      serialized_options=_b('\242\324\030\032#GameUI_ServerRejectBanned'),
      type=None),
  ],
