...
_EEVENT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVENT_ID_COUNT', index=31, number=31,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
